...
public class Main_SideBarPageConfig implements SidebarPageConfig{
	...
	public Main_SideBarPageConfig(){		
		pageMap.put("fn1",new SidebarPage("ufba", "UFBA", "/imagens/icons/add.png", "http://www.ufba.br"));
		pageMap.put("fn2",new SidebarPage("ufba_dcc", "UFBA DCC", "/imagens/icons/users.png", "http://www.dcc.ufba.br"));
